	...
	<body>
		<section class="navbar">
		    <div class="container">
				...
				<?php
					if (isset($_SESSION['user'])){
						echo "<a id=\"goto-login\" href=\"logout.php\" title=\"Sign out\"><img src=\"picture/logo-login.png\"/></a>";
						echo "<p id=\"username\">Good day, " . $_SESSION['user'] . "!</p>";
					}
					else{ 
						echo "<a id=\"goto-login\" href=\"login.php\" title=\"Sign in\"><img src=\"picture/logo-login.png\"/></a>";
					}
				?>
		    </div>
		</section>
		        	...
		        	<li id="buy-more-song" class="active">
		       		...
		       		<li id="get-signature">
		          		<a href="#getsignature" title="Get signature">
		            		<i class="fa fa-certificate"></i> chữ kí
		          		</a>
		       		</li>
		       		<?php
			...
			<table class="songstable">
				<thead>
					<tr>
						...
						<th class="col-xs-2">Trình Trạng/hoạt động</th>
					</tr>
				</thead>
